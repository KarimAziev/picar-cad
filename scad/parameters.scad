...
rack_base_h                                        = 9.0;
rack_steering_servo_z_offset                       = 4;
...
// Hole inside ethernet jack
rpi_ethernet_jack_hole_size                        = [10.47, 7.9, 13.40];
...
steering_servo_to_pan_hole_wiring_holes_size       = [20, 5];
steering_servo_to_raspberry_hole_wiring_holes_size = [36, 5];
