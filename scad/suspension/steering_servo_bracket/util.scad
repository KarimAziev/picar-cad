...
function steering_servo_bracket_params(lower_thickness_clearance=steering_servo_bracket_lower_thickness_clearance) =
  let (servo_bolt_through_l = dsservo_hat_thickness + steering_servo_bracket_thickness,
