...
function knuckle_full_w() =
  ...
  echo("knuckle_h", knuckle_h, "ball_stud_housing_h", ball_stud_housing_h)
...
module knuckle_left(color=color,
  ...
  lower_arm_y_angle = y_angle_from_zshift(-knuckle_z_shift, lower_arm_size[0]);
  upper_arm_y_angle = y_angle_from_zshift(-knuckle_z_shift, upper_arm_size[0]);
...
full_w = knuckle_full_w();
full_l = knuckle_assembly_full_len();
// knuckle_printable();
// translate([-full_l / 2, 0, 0]) {

//   cube(size=[full_l, full_w, 1]);
// }
